...
public class DetailProximasData {
    ...
    public DetailProximasData(String nombre, String modalidad, String pais, String localidad, String descripcion, float distancia, Date fecha, float precio) {
        setNombre(nombre);
    ...
    public boolean equals(Object obj){
        if (obj instanceof DetailProximasData){
            DetailProximasData data = (DetailProximasData) obj;
            if(data.getId() == getId()){
                return true;
            }
        }
